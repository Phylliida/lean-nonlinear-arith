...
- [nla-14 Slice 4 plan `boarded` (2026-08-14, planning sweep — the `nonlinear_arith` elab + L1/L2 layering + acceptance; decisions D1–D3 resolved by Danielle's standing principles: dev elabs stay, optional round numeral mirrors nla_saturate, no maxConflicts threading — UINT_MAX is z3's own default)](board/nla-14-slice-4-tactic-acceptance.md) `boarded`
